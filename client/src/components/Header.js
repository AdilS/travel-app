                    ...
                    <div className="header-left">
                        ...
                        <div className="dropdown for-message">
                            ...
                            <div className="dropdown-menu" aria-labelledby="message">
                                ...
                                <a className="dropdown-item media" href="#">
                                    <span className="photo media-left"><img alt="avatar" src={JPG1} /></span>
                                ...
                                <a className="dropdown-item media" href="#">
                                    <span className="photo media-left"><img alt="avatar" src={JPG2} /></span>
                                    <div className="message media-body">
                                ...
                                <a className="dropdown-item media" href="#">
                                    <span className="photo media-left"><img alt="avatar" src={JPG3} /></span>
                                    <div className="message media-body">
                                ...
                                <a className="dropdown-item media" href="#">
                                    <span className="photo media-left"><img alt="avatar" src={JPG4} /></span>
                                    <div className="message media-body">
